...
**DEVOPS follow-up (gated, NOT blocking):** set `INFERER_BACKEND=lightrag` + `ANTHROPIC_API_KEY` + pin `lightrag-hku` (`[live]` extra) to flip live; mandatory prompt-injection re-audit at the flip.
