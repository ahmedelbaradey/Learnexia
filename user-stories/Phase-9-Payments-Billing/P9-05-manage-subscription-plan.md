...
- The benefits view shows **both pricing options** and the annual saving: **Monthly = 199 EGP** and **Annual = 1990 EGP** (≈ 10 months' price, saves ~2 months). Prices are config-driven via P9-12 (`subscription.monthlyPriceEgp` / `subscription.annualPriceEgp`), never hard-coded.
