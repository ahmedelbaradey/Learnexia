...
- **Requirements:** FR-PAY-4 *(new — Phase 9)*
...
- **Refunds** (P9-09) appear as linked negative entries.
- Only the **owning parent** can view their own history (no cross-account access).

## Notes
- **Parent-app / parent-account surface only** — never shown in the student app. Blocked by **P9-06**. Receipt fields may have EGP/VAT requirements — confirm with finance.
