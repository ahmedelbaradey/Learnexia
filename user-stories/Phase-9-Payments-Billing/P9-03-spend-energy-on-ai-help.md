...
- **Requirements:** FR-CREDIT-3 *(new — Phase 9)*
...
## Acceptance Criteria
- Per-action cost (config-driven, P9-11): **hint = 1, explain-mistake = 3, deep-explanation = 5, practice-generation = 5**.
...
- Insufficient balance → the Helper declines gracefully with a low-energy message (P9-04) and serves a cached canned explanation when available — **never blocks learning**.
