...
## Notes
- Costs are consumed by **P9-02 / P9-03 / P9-04**. Admin-only per SRS §3 (no teacher role). Blocked by **P9-01**. Grant/cap defaults reflect the revised credit economy (1 credit ≈ 1¢).
