...
- **Wave 7:** P2-11-BE Batches 1–4 (skill dependency graph: KnowledgeNode/Edge entities + migration + acyclic DFS validator + GetPrerequisites/UnlockedBy CQRS queries + KnowledgeGraphController + seeder extension + 6 integration tests) — Batch 1 merged via PR #56; Batches 2–4 ready for PR on feat/P2-11-skill-dependency-graph
- **Wave 7:** P2-02-BE Batch 1 (browse subjects/lessons/skill-tree queries) — merged via PR #57; api-tester + reviewer pending
- **Wave 7:** P2-08-BE Batch 1 (query perf indexes for attempts + student_answers) — merged via PR #58; command/query batches pending
