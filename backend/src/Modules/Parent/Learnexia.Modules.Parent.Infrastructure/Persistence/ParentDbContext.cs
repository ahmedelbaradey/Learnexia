...
public class ParentDbContext : DbContext
{
    ...
    /// <summary>
    /// Persisted weekly reports generated by the Hangfire scheduled job (P5-01-BE-3).
    /// One row per (ChildId, WeekStartUtc) — unique index enforces idempotent per-week upsert.
    /// </summary>
