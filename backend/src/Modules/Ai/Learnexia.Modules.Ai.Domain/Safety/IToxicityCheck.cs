...
/// <summary>
/// Checks AI-generated content for toxic language (profanity, hate speech, harassment, etc.)
...
/// <see cref="ReasonCodes.ToxicityCheckError"/>. Returning <see cref="CheckVerdict.Pass"/>
/// when the check cannot complete is a security violation (FR-AI-4, AC3).</para>
///
/// <para>Implemented by <c>ToxicityCheck</c> in <c>Ai.Infrastructure/Safety/</c>.</para>
/// </summary>
public interface IToxicityCheck
{
    /// <summary>
    /// Evaluate <paramref name="content"/> for toxicity in the given <paramref name="language"/>.
    /// </summary>
