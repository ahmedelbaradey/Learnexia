...
namespace Learnexia.Modules.Learning.Infrastructure.Migrations
{
    ...
    [Migration("20260630095626_P3_13a_AddBehavioralProfileDepth")]
    partial class P3_13a_AddBehavioralProfileDepth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Learnexia.Modules.Learning.Domain.Entities.KnowledgeNode", b =>
                {
                    ...
                    b.HasIndex("SkillKey")
                        ...
                        .HasFilter("\"learning\".\"KnowledgeNodes\".\"SkillKey\" IS NOT NULL");
            ...
            modelBuilder.Entity("Learnexia.Modules.Learning.Domain.Entities.QuestionDifficultyStats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("AvgTimeSpentSeconds")
                        .HasColumnType("double precision");
                    ...
                    b.Property<double>("HintUsageRate")
                        .HasColumnType("double precision");
                    ...
                    b.ToTable("QuestionDifficultyStats", "learning");
                });

            modelBuilder.Entity("Learnexia.Modules.Learning.Domain.Entities.QuestionRecalibrationProposal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("EvidencePValue")
                        .HasColumnType("double precision");

                    b.Property<int>("EvidenceSampleSize")
                        .HasColumnType("integer");

                    b.Property<bool?>("IsDeleted")
                        .HasColumnType("boolean");

                    b.Property<int>("ProposedDifficulty")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("QuestionRecalibrationProposals", "learning");
                });
            ...
            modelBuilder.Entity("Learnexia.Modules.Learning.Domain.Entities.StudentLearningProfile", b =>
                {
                    ...
                    b.Property<double?>("MasteryVelocity")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("Learnexia.Modules.Learning.Domain.Entities.StudentRecommendation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StudentId", "RecommendationDate")
                        .IsUnique()
                        .HasDatabaseName("UX_StudentRecommendations_StudentId_RecommendationDate");

                    b.ToTable("StudentRecommendations", "learning");
                });
