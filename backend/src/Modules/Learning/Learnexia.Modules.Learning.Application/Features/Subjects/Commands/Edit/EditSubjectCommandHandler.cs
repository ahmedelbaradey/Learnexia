...
public class EditSubjectCommandHandler : BaseResponseHandler, ICommandHandler<EditSubjectCommand, BaseResponse<string>>
{
    ...
    public EditSubjectCommandHandler(ILearningServiceManager service, ILoggerManager logger, IStringLocalizer<SharedResources> localizer)
    {
        _logger = logger;
        _service = service;
    ...
    public async Task<BaseResponse<string>> Handle(EditSubjectCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            return await _service.SubjectService.UpdateAsync(request);
        }
        catch (Exception ex)
        {
