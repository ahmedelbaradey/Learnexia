    ...
    : BaseResponseHandler, IQueryHandler<ListQuery, BaseResponse<List<NotificationResponse>>>
{
    ...
    public ListQueryHandler(INotificationInboxService inboxService, ILoggerManager logger)
    {
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            var items = await _inboxService.ListByRecipientAsync(request.RecipientUserId, cancellationToken);
