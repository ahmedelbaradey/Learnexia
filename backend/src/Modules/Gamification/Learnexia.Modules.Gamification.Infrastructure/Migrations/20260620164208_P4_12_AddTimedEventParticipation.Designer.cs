...
namespace Learnexia.Modules.Gamification.Infrastructure.Migrations
{
    ...
    [Migration("20260620164208_P4_12_AddTimedEventParticipation")]
    partial class P4_12_AddTimedEventParticipation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Learnexia.Modules.Gamification.Domain.Entities.TimedEvent", b =>
                {
                    ...
                    b.Property<int?>("ParticipationTarget")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TimedEvents", "gamification", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_TimedEvents_ParticipationTarget", "\"ParticipationTarget\" IS NULL OR \"ParticipationTarget\" > 0");
                        });
                });

            modelBuilder.Entity("Learnexia.Modules.Gamification.Domain.Entities.TimedEventParticipation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Status", "EventEndUtc")
                        .HasDatabaseName("IX_TimedEventParticipations_Status_EventEndUtc");

                    b.HasIndex("TimedEventId", "StudentXpProfileId")
                        .IsUnique()
                        .HasDatabaseName("UX_TimedEventParticipations_TimedEventId_StudentXpProfileId");

                    b.ToTable("TimedEventParticipations", "gamification", t =>
                        {
                            t.HasCheckConstraint("CK_TimedEventParticipations_Progress", "\"Progress\" >= 0 AND \"Progress\" <= \"Target\"");
                        });
                });
            ...
            modelBuilder.Entity("Learnexia.Modules.Gamification.Domain.Entities.TimedEventParticipation", b =>
                {
                    ...
                    b.HasOne("Learnexia.Modules.Gamification.Domain.Entities.TimedEvent", null)
                        .WithMany()
                        .HasForeignKey("TimedEventId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
