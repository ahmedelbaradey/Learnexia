...
namespace Learnexia.Modules.Billing.Infrastructure.Migrations
{
    ...
    [Migration("20260618005545_AddParentPauseStateToChildSeat")]
    partial class AddParentPauseStateToChildSeat
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Learnexia.Modules.Billing.Domain.Entities.SeatReservation", b =>
                {
                    ...
                    b.Property<int>("ParentPauseState")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);

                    b.Property<DateTime?>("ParentPauseStateChangedAt")
                        .HasColumnType("timestamptz");
